...
public class HbaseSet {
    ...
    */
    public static class myMapper extends TableMapper<Text, IntWritable>  {
    	...
    	public void map(ImmutableBytesWritable row, Result value, Context context) throws IOException, InterruptedException {
    		...
    		if(selectVar.equals(sqlData[2])&&selectDevice.equals(sqlData[1])&&sqlDateint>=startDate&&sqlDateint<=endDate){
        		...
        		sqlYear=sqlData[0]+":"+sqlData[1]+":"+sqlData[2]+":"+sqlYear;
   ...
   public static class Reduce extends TableReducer<Text,IntWritable,NullWritable>{
	   ...
	   public void reduce(Text key,Iterable<IntWritable> values,Context context) throws IOException, InterruptedException{
		   ...
		   put.add(Bytes.toBytes("context"),Bytes.toBytes("average"),Bytes.toBytes(String.valueOf(average)));
    ...
    * 插入一行记录   
    */    
   public  void addRecord (HTable table, String rowKey, String family, String qualifier, String value)     
           throws Exception{     
       try {     
           //HTable table = new HTable(conf, tableName);如果动态插入record需要注意不能够在循环中创建大对象否则可能出现内存溢出错误。     
...
//		   SetHbase.addRecord(table,"20100101:20150830:shanghai:dxtx:1G",familys[0],familys[0],"just have a try!");
   ...
   public static void setHbaseData(String tableName,String rowkey) throws Exception{
	   tableName="jwtyc";
			   ...
			   for(int dateInt=10;dateInt<=10;dateInt++){
				   for(int hour=0;hour<24;hour++){
					   for(int minute=0;minute<60;minute++){
						   rowkey="jwtyc:1#:dwzlbs:";
						   if(month<10){
							   rowkey=rowkey+year+"0"+month+dateInt+":"+hour+":"+minute;
						   }else{
							   rowkey=rowkey+year+month+date+":"+hour+":"+minute;
						   }
						  
							   ackSecond=Integer.toString((int)(3*Math.random()+19));
   ...
   public static String outTitle(String station,String device,String typeVar,Boolean is_bj)throws Exception{
	   String stationName="";
	   String varName="";
	   String title="";
   ...
   public static String outDsp(String station,String device,String typeVar,String startTime,String endTime,String index,Boolean is_bj)throws Exception{
	   String stationName="";
	   String varName="";
	   String dsp="";
	   if(station.equals("rmgc")){
	   ...
	   if(typeVar.equals("gddy")){
		   if(is_bj){
			   dsp="从"+startTime+"到"+endTime+"时间段分析中，"+stationName+"的设备"+device+"的"+varName+"发生异常，具体情况是"+varName+"趋势下降过快，下降率为"+index+"伏/月，可能发生危险。";
		   }else{
			   dsp="从"+startTime+"到"+endTime+"时间段分析中，"+stationName+"的设备"+device+"的"+varName+"未发生报警。";
		   }
		  
	   }else if(typeVar.equals("dwzlbs")){
		   if(is_bj){
			   dsp="从"+startTime+"到"+endTime+"时间段分析中，"+stationName+"的设备"+device+"的"+varName+"发生异常，具体情况是"+varName+index.substring(0, index.length()-1)+"月监测值异常"+"，可能发生危险。";
		   }else{
			   dsp="从"+startTime+"到"+endTime+"时间段分析中，"+stationName+"的设备"+device+"的"+varName+"未发生报警。";
		   }
		   ...
		   if(is_bj){
			   dsp="从"+startTime+"到"+endTime+"时间段分析中，"+stationName+"的设备"+device+"的"+varName+"发生错误报警,可能发生危险。";
		   }else{
			   dsp="从"+startTime+"到"+endTime+"时间段分析中，"+stationName+"的设备"+device+"的"+varName+"未发生报警。";
		   }
   ...
   public static JSONObject resulttojson(String targetTable,String station,String device,String typeVar,String startDate,String endDate) throws Exception{
		   ...
		   if (y==startYInt){
			   for(int m=startMInt;m<=12;m++){
				   ...
				   if(0<m&&m<10){
					   ...
					   byte[] value=rowresult.getValue(familys[0].getBytes(),familys[1].getBytes());
	   ...
	   resultJson.put("dsp", outDsp(station,device,typeVar,startDate,endDate,anaResult,Is_bj));
   ...
   public static String finalReturn(String[] anaObjects,String targetTable,String startTime,String endTime,String sbType) throws Exception{
	   String stationName;
	   String device;
	   String typeVar;
	   ...
	   SetHbase.addRecord(tableHis,hisRow,"value","value",myJson.toString());
	   return myJson.toString();
   }
   @SuppressWarnings("deprecation")
   public static void runJob(String[] analysisObj)
    throws Exception {
   ...
   public static String runHbase(String[] anaTables,String targetTable,String startTime,String endTime,String sbType) throws Exception{
	   ...
	   String finalString="";
	   finalString=finalReturn(anaTables,targetTable,startTime,endTime,sbType);
   ...
   public static void main (String [] agrs) throws Exception {
	  // String tableName="hsah";
	   ...
	   String[] test={"rmgc:1#:gddy"};
	   
//	   String testss=runHbase(test,"AnalysisResult",agrs[2],agrs[3]);
...
//	   endDate=Integer.parseInt(enddate);
	  // addHistory("");
	   ...
	   //String webreturn=resulttojson(tableName[1],"shenyang","3G","gddy",agrs[2],agrs[3]);
	   //return null;	   
   }     
}
